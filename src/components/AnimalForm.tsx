  ...
  return (
    <form onSubmit={onSubmit} className="surface overflow-hidden">
      ...
      <div className="grid gap-4 p-4 sm:p-5 md:grid-cols-2">
        ...
        <label className="field-label md:col-span-2">Notes<textarea name="notes" className="input min-h-32 resize-y" defaultValue={animal?.notes ?? ""} placeholder="Temperament, breeding notes, pasture history..." /></label>
      </div>
